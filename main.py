...
def notify_signal(data, result):
    ...
    signal = decide_signal(up_prob, down_prob)

    jst = latest_time.tz_convert(ZoneInfo("Asia/Tokyo"))
    now = datetime.now(ZoneInfo("Asia/Tokyo"))
    signal_id = jst.strftime("%Y%m%d_%H%M")
    ...
    print(f"signal saved: {signal_id} {signal}")
